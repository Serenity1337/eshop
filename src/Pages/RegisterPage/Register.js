...
export const Register = () => {
  ...
  return (
    <div className={classes.registerContainer}>
        ...
        <input type="text" name='firstName' onChange={accountHandler} placeholder='First Name'/>

        <input type="text" name='lastName' onChange={accountHandler} placeholder='Last Name'/>
        </div>

        <div className={classes.pairing}>
        <input type="email" name='email' onChange={accountHandler} placeholder='Email'/>

        <input type="text" name='phoneNumber' onChange={accountHandler} placeholder='Phone Number'/>
        </div>

        <div className={classes.pairing}>
        <input type="password" name='password' onChange={accountHandler} placeholder='Password'/>

        <input type="password" name='rpassword' onChange={accountHandler} placeholder='Repeat Password' />
        </div>
        {profileErrorState ? 
