  ...
  return (
    <div className={classes.homeContainer}>
      ...
      <div className={classes.landingSection}>
        ...
        <p><span>Go further than you thought with</span> <span>CapacityX supplements</span></p>
      ...
      <div className={classes.motivationSection}>
        <div className={classes.motivation}>
          <div className={classes.information}>
        <h1>we create products<br/>to help you reach the<br/>fitness goals you<br/>never knew you had</h1>
        <p>I'm a paragraph. Click here to add your own<br/> text and edit me. It's easy. Just click "Edit<br/> Text" or double click me to add your own<br/> context and make changes to the font.</p>
      ...
      capacityx fitness blog
        ...
        <div className={classes.blogPosts}>
          <div className={classes.blogPostOne}>
            ...
            <div className={classes.blogPostTitle}>3 ways to build bigger arms faster</div>
          </div>
          <div className={classes.blogPostTwo}>
        <div className={classes.blogPosterName}>Karolis Šulcas</div>
        <div className={classes.blogPostDate}>Oct 11 1 min ago</div>
        <div className={classes.blogPostTitle}>how to push past your peak performance</div>
      </div>

      <div className={classes.blogPostThree}>
        <div className={classes.blogPosterName}>Karolis Šulcas</div>
        <div className={classes.blogPostDate}>Oct 11 2 min ago</div>
        <div className={classes.blogPostTitle}>the best time to drink your protein and why</div>
      </div>
        </div>
